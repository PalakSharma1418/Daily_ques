// Last updated: 12/11/2025, 7:34:37 AM
class Solution {
    ...
    private boolean check(long mid, long[] diff, int r, long k, int n) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (cumSum < mid) {
                ...
                // kyuki na i to kam hai hum i+r par rkhte hai taki (jyda range mai benfite ho ) i+r par rkha to i---i+r---i+r+r
                if (i + 2L * r + 1 < n) {
...
// https://chatgpt.com/c/690dfa9c-cbdc-8324-86da-ca51fe05825e