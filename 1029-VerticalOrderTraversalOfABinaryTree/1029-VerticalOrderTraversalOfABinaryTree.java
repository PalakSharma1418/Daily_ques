// Last updated: 1/9/2026, 10:58:11 AM
/**
...
class VerticalPair{
    TreeNode node;
    int l;//row  levelorder bala
    int v;//col
    public VerticalPair(TreeNode node, int l ,int h){
        this.l= l;
        this.v=h;
        this.node=node;
    }
...
// Collections.sort(ll, (o1, o2) -> {
    ...
    //     return o1.node.val - o2.node.val;
    // }
    // return o1.l - o2.l;  // compare by l if they are different
// });
// 